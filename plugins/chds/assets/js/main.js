		...
		$.ajax({
			...
			success : function(data) {
				...
				if(data.code == 0){
					...
					if(data.pay_usdt>0){
						paymsg+='<button class="btn btn-default btn-block" onclick="dopay(\'usdt\',\''+data.trade_no+'\')" style="margin-top:10px;"><img src="assets/img/usdt.png" class="logo">USDT支付</button>';
					}
					if (data.pay_rmb>0) {
